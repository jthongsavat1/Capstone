...
class SearchScreenChat extends StatefulWidget {
  const SearchScreenChat({super.key});

  @override
  State<SearchScreenChat> createState() => _SearchScreenState();
}

class _SearchScreenState extends State<SearchScreenChat> {
  String name = "";
